...
import org.firstinspires.ftc.team2844.Team2844_Decode.RoadrunnerStuff.RoadrunnerQuickstart.messages.ThreeDeadWheelInputsMessage;

@Config
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2041.5202793245392; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2199.826182562763; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3417.4060854286877; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        ...
        //   par0.setDirection(DcMotorSimple.Direction.REVERSE);
                                                                                                                                                                                                        par0.setDirection(DcMotorSimple.Direction.REVERSE); //maybe not needed?
