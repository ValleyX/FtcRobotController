...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3.829; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 5.737; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        ...
        driver.setOffsets(PARAMS.perpXTicks, PARAMS.parYTicks, DistanceUnit.INCH);
