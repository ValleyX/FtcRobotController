...
@Autonomous(name = "Red far Goal 3 Ball")
public class RedFarAutoThreeBall extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Servo timerLight = hardwareMap.get(Servo.class, "timerLight");
        ...
        TrajectoryActionBuilder moveOut = mecanumDrive.actionBuilder(new Pose2d(new Vector2d(-60, -17), Math.toRadians(-25)))
                .strafeToLinearHeading(new Vector2d(-63.5,-72+9), Math.toRadians(-90.0))
