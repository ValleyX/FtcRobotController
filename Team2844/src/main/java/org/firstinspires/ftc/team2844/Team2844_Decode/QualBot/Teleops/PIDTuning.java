...
//            }
            ...
            PIDFCoefficients newShooterCoefficients = new PIDFCoefficients(p, i, d, f);
            shooterHardware.shooterMotor.setVelocityPIDFCoefficients(p, i, d, f);
            ...
            telemetry.addData("Power", shooterHardware.shooterMotor.getPower());
