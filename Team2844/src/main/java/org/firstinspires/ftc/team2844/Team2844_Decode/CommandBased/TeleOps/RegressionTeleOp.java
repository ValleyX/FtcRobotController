...
import org.firstinspires.ftc.team2844.Team2844_Decode.CommandBased.Commands.ShootingCommands.DefaultVelocityRegCmd;
...
public class RegressionTeleOp extends CommandOpMode {
    ...
    public void initialize() {
        ...
        m_driveOp.getGamepadButton(GamepadKeys.Button.X)
                .whenPressed(new InstantCommand(() ->velocity.addToNum(Constants.REG_STEP)));
...
//            }
            ...
            telemetry.addData("expected Velocity", velocity.getAsDouble());
            ...
            telemetry.addData("Velocity P: ", subsystems.shooterSubsystem.getPIDs()[0]);
            telemetry.addData("Velocity I: ", subsystems.shooterSubsystem.getPIDs()[1]);
            telemetry.addData("Velocity D: ", subsystems.shooterSubsystem.getPIDs()[2]);
